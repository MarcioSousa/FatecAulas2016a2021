...
public class Aplic {
    public static void main(String[] args) {
       ...
       unidade = entrada.next(); //entrada de caracteres sem espaço 
       ...
       do{
           ...
           System.out.println("\nMedida da altura: " + df.format(objRet.getAltura()) + " " + 
                                                       objRet.getUnidadeMedida());
           System.out.println("Medida da base: " + df.format(objRet.getBase()) + " " + 
                                                       objRet.getUnidadeMedida());
           
           switch(opcao){                                        
                case 1: System.out.println("Área: " + df.format(objRet.calcArea())+ " " + 
                                                      objRet.getUnidadeMedida() +"²");
                        break;       
                                                    
                case 2: System.out.println("Perímetro: " + df.format(objRet.calcPerimetro()) + " " + 
                                                           objRet.getUnidadeMedida());
                        break;
                case 3: System.out.println("Diagonal: " + df.format(objRet.calcDiagonal()) + " " + 
                                                          objRet.getUnidadeMedida());
                        break;        
           }
       }while (opcao < 4);  
