...
insert into produto (nome, fabricacao, valor) values ('Pizza de Calabresa','Pizzaria Rei', 21.00);
insert into produto (nome, fabricacao, valor) values ('Pizza de Mussarela','Pizzaria Rei', 20.50);
