package com.example.marciosousa.aulaandroidoreo;
...
public class AeroportoActivity extends Activity {
    ImageView imagem;
    TextView texto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagem = findViewById(R.id.ImgMinhaImagem);
        texto = findViewById(R.id.TxtMeuTexto);
