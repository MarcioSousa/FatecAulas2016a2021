package com.example.marciosousa.jokempo;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botaopedra = findViewById(R.id.btnpedra);
        botaopapel = findViewById(R.id.btnpapel);
        botaotesoura = findViewById(R.id.btntesoura);
